...
struct Estado {
 ...
 void iniciarBaralho() {
      ...
      baralho[0].superPoder = baralho[0].população + baralho[0].area * baralho[0].pib / 6;
      ...
      baralho[1].superPoder = baralho[1].população + baralho[1].area * baralho[1].pib / 6;
 ...
 int main() {
     ...
     // Função para comparar as cartas;
        ...
        if(baralho[0].superPoder > baralho[1].superPoder) {
            ...
            printf("\n Carta 1 (São Paulo) é a vencedora!\n");

        } else if (baralho[0].superPoder < baralho[1].superPoder) {

            printf("\n Carta 2 (Rio de Janeiro) é a vencedora!\n");
